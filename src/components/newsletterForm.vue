<template>
  <section>
    <section class="lg:flex lg:flex-col lg:justify-center lg:items-start lg:mt-16">
      <form class="lg:w-128"
        name="contact"
        method="post"
        ...
        <button class="w-full py-4 font-semibold text-gray-100 bg-red-900 rounded-full uppercase hover:bg-red-800 lg:text-lg focus:outline-none" type="submit">Subscribe Now</button>
      </form>
    </section>
  </section>
</template>
